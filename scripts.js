...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (agentLoginForm) {
        ...
        agentLoginForm.addEventListener('submit', (e) => {
            ...
            console.log(`Agent found: ${currentUser.name}, isAdmin: ${currentUser.isAdmin}`);
    ...
    if (defendantLoginForm) {
        console.log("Defendant login form found");
        defendantLoginForm.addEventListener('submit', (e) => {
            e.preventDefault();
            console.log("Defendant login form submitted");
            ...
            console.log(`Redirecting to defendant-dashboard for ${currentUser.id}`);
    ...
    if (agentSignupForm) {
        console.log("Agent signup form found");
        agentSignupForm.addEventListener('submit', (e) => {
            e.preventDefault();
            console.log("Agent signup form submitted");
            const agent = {
    ...
    if (window.location.pathname.endsWith('defendant-dashboard.html')) {
        console.log("Loaded defendant dashboard");
        if (!currentUser) {
    ...
    // Agent Dashboard (with Admin Tools)
    if (window.location.pathname.endsWith('agent-dashboard.html')) {
        ...
        try {
            ...
            console.log("User confirmed, proceeding. isAdmin:", currentUser.isAdmin);
            ...
            document.querySelectorAll('.nav-btn').forEach(button => {
                button.addEventListener('click', (e) => {
                    ...
                    console.log(`Clicked nav button for section: ${sectionId}`);
            ...
            document.querySelectorAll('.sidebar a').forEach(link => {
                link.addEventListener('click', (e) => {
                    e.preventDefault();
                    const sectionId = e.currentTarget.getAttribute('data-section');
                    console.log(`Clicked sidebar link for section: ${sectionId}`);
                    showSection(sectionId);
                });
            });
